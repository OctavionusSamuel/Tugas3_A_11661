...
st.markdown("""
<div class="center">
    <img src="https://media.tenor.com/oq]o9GcbfjYAAAAi/welcome-images-server.gif" alt="Welcome Image">
</div>
""", unsafe_allow_html=True)

st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1661</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'C:\Users\Asus\Kuliah\Semester 5\PMDPM\Pertemuan 06\Tugas3_A_11661'
    ...
    if os.path.exists(model_path):
        ...
        RR_model = loaded_model[2]

        # Sidebor input untuk nilai
